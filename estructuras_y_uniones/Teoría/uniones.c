...
/* Uniones.
 * El programa muestra la manera como se declara una unión, así com la forma de
 * acceso a los campos de las variables de tipo tanto para asignación de valores
 * como para lectura y escritura. */

union datos         // Declaración de unión.
{
    char celular[15];
    char correo[20];
};
...
void main(void)
{
    ...
    /* Para que puedas observar las diferentes formas en que los campos de las variables
     * de tipo estructura alumno reciben valores, ingresammos los valores de los
     * campos de tres formas diferentes. Los campos de a1 reciben valores
     * directamente, los campos de a2 se leen en el programa principal, y los campos
     * de a3 reciben valores a través de una función. */

    printf("Alumno 2/n");
    printf("Digite la matrícula: ");
    ...
    printf("Digite el correo electrónico: ");
    gets(a2.personales.correo);
    /* Observa que en la variable a2 de tipo estructura alumno el segundo campo
    de la unión recibe un valor. */
    ...
    printf("Digite el teléfono celular del alumno 2: ");
    fflush(stdin);
...
// La función Lectura se utiliza para leer los campos de una variable de tipo estructura alumno.
{
    ...
    printf("Digite el promedio: ");
    scanf("%f", &a->promedio);
    printf("Digite el teléfono celular: ");
    fflush(stdin);
