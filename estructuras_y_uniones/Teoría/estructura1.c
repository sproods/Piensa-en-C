...
/* Función que permite leer los campos de un apuntador de tipo estructura empleado. */
{
    ...
    printf("Digite el departamento de la empresa: ");
    gets(a->departamento);

    printf("Digite el sueldo del empleado: ");
    scanf("%f", &a->sueldo);
    fflush(stdin);

    printf("__-Digite la dirección del empleado__-");
    printf("\n\tCalle: ");
...
void main(void)
{
    ...
    /* En el programa principal se leen los campos de una variable, e3,
     * y un apuntador de tipo estructura, *e1. */
    e1 = new (struct empleado);
    printf("\nDigite el nombre del empleado 1: ");
    scanf("%s", &(*e1).nombre);
    fflush(stdin);

    printf("Digite el departemento de la empresa: ");
    ...
    printf("\nDigite el nombre del empleado 3: ");
    scanf("%s", &e3.nombre);
    fflush(stdin);

    printf("Digite el departamento de la empresa 3: ");
    gets(e3.departamento);

    printf("Digite el sueldo del empleado 3: ");
    scanf("%f", &e3.sueldo);
    ...
    /* En la función Lectura se leen los campos de una variable, e4,
     * y un apuntador de tipo estructura, *e2. */
