...
void Lectura(alumno *, int T);        // Prototipos de funciones.
...
/* La función lectura se utiliza para leer un arreglo unidimesional de tipo estructura
 * alumno de T elementos. */
{
    int I, J;
    ...
    for (I = 0; I < T; I++)
    {
        ...
        for (J = 0; J < 5; J++)
        {
            printf("\tDigite la calificación %d del alumno %d: ", J + 1, I + 1);
            scanf("%f", &A[I].cal[J]);
        }
    }
}
