...
{
    int matricula;      // Campos de la estructura alumno.
    char nombre[20];
    char carrera[20];
    float promedio;
    char direccion[20];
...
void main(void)
{
    struct alumno a0 = {120, "María", "Contabilidad", 8.9, "Querétalo"};
    struct alumno *a3, *a4, *a5, a6;
    /* Observa que las variables *a3, *a4, *a5 se declaran como apuntadores de
     * tipo estructura alumno. a6 es una variable de tipo estructura alimno. */
     ...
     * Para tener acceso a los campos de un apuntador de tipo estructura, utilizamos
     * uno de los formatos siguientes: apuntador -> campo  o bien (*apuntador).campo
     * En la lectura de los campos de la variable a4 se utilizan como ejemplo ambos
     * formatos. */

    printf("\nDigite la matrícula del alumno 4: ");
    scanf("%d", &(*a4).matricula);
    fflush(stdin);

    printf("Digite el nombre del alumno 4: ");
    gets(a4->nombre);

    printf("Digite la carrera del alumno 4: ");
    gets((*a4).carrera);

    printf("Digite el promedio del alumno 4: ");
    scanf("%f", &a4->promedio);
    fflush(stdin);

    printf("Digite la dirección del alumno 4: ");
    gets(a4->direccion);
...
/* Esta función permite leer los campos de un apuntador de tipo estructura alumno. */
{
    ...
    printf("Digite la carrera del alumno: ");
    gets((*a).carrera);
    ...
    printf("Digite la dirección del alumno: ");
    gets(a->direccion);
}