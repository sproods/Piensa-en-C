...
/* Hospital.
 * El programa genera infomación acerca de los pacientes de un hospital. */
...
void Lectura(paciente *, int);      // Prototipos de funciones.
...
void main(void)
{
    ...
    do
    {
        printf("Digite el número de pacientes: ");
        scanf("%d", &TAM);
        fflush(stdin);
    }
...
/* Esta función se utiliza para obtener el porcentaje tanto de hombres como de mujeres
...
/* Esta función se utiliza para ontener el número de pacientes que ingresaron al hospital
 * en cada una de las categorías de condición. */
{
...
/* La función F3 se utiliza para generar el nombre y teléfono de todos los pacientes
 * quee tuvieron una condición de ingreso de máxima gravedad (5). */
{
    int I;
