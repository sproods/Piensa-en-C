 ...
 * minúscula- la reemplaza por su forma correcta y escribe la cadena en
 * otro archivo. */
...
void cambia(FILE *ap1, FILE *ap2)
{
     ...
     * con minúsculas -la primera letra- por su forma correcta y escribe la
     * cadena de caracteres en un nuevo archivo. */
    
    int i, j, k;
    char cad[50], *cad1 = "", *cad2 = "", aux[50];
