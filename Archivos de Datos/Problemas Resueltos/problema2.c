...
/* Cuenta caracteres.
 * El programa, al recibir como dato un archivo de texto y un caracter,
 * cuenta el número de veces que se encuentra el caracter en el archivo. */
...
void main(void)
{
    ...
    printf("\nDigite el caracter que se va a buscar en el archivo: ");
    car = getchar();
    res = cuenta(car);
