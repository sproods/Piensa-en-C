 ...
 * ordenados en función de la matrícula. */
{
    ...
    {
        if (b)          /* Si la bandera b está encendida, se lee el archivo ar, la matrícula y las tres calificaciones del alumno. */
        {
            fscanf(ar, "%d", &mat);
            for (i = 0; i < 3; i++)
                fscanf(ar, "%f", &ca[i]);
        ...
        if (b1)         /* Si la bandera b1 está encendida, se lee el archivo ar, la matricula y las tres calificaciones del alumno. */
        {
            fscanf(ar1, "%d", &mat1);
            for (i = 0; i < 3; i++)
                fscanf(ar1, "%f", &ca1[i]);
