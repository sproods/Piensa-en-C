...
void main (void)
{
    ...
    /* Observa que las dos instrucciones del programa del ejemplo 1 necesarias para abrir un archivo
     * y verificar que éste en realidad se haya abierto, se pueden agrupar en una sola instrucción. */
    {
        while (!feof(ar))
