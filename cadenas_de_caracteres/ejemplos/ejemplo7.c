...
{
    int i;
    char cad0[20] = "Hola Perú";
    char cad1[20] = "Hola México";
    char cad2[20] = "Hola Argentina";
    char cad3[20] = "Hola Colombia";
    char *c, c3;

    i = strcmp(cad0, cad1);
    /* La función strcmp permite comparar dos cadenas de caracteres.
    Si la primera cadena -en este caso cad0- es mayor a la segunda -cad1-, regresa un valor positivo; si es menor, un valor negativo y de otra forma, 0. */
    ...
    i = strlen(cad0);
    /* La función strlen obtiene la logitud -el número de caracteres- de una cadena. */
    printf("\nLongitud cadena cad0: %d", i);

    i = strlen(cad1);
    printf("\nLongitud cadena cad1: %d", i);

    c = strchr(cad1, 'M');          /* c es un apuntador de tipo caracter. */
