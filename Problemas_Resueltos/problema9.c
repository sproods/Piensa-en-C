...
/* Esta función se utiliza para leer un arreglo tredimensional de tipo real de F filas, C columnas y P planos de profundidad. */
{
	int K, I, J;
	for (K = 0; K < P; K++)
		for (I = 0; I < F; I++)
...
/* Esta función se utiliza para localizar el mes con mayor registro de lluvias en la provincia 18 en el quinto año. Escribe además el registro correspondiente. */
{
	int J, EMES = -1;
	float ELLU = -1.0;
	for (J = 0; J < C; J++)
