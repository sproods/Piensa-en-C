...
void LecturaM(float [][12], int, int);		/* Prototipos de funciones. */
...
/* La función F1 se utiliza para calcular el rendimiento anual de los fondos de inversión. El resultado se almacena en el arreglo unidimensional V. */
{
	int I;
