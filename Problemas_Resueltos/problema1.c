...
/* La función Lectura se utiliza para leer un arreglo bidimensional cuadrado de tipo entero de T filas por T columnas. */
{
	int I, J;
	for (I = 0; I < T; I++)
		for (J = 0; J < T; J++)
...
/* La función Simetrico se utiliza para deteminar si el arreglo bidimensional cuadrado es simétrico. Si es simétrico regresa 1, en caso contrario, 0.
